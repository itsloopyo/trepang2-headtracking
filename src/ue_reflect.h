...
// The first property of `ustruct` whose name starts with `prefix`. A
// blueprint-authored struct suffixes every member with a GUID
// ("FOV_2_D9A4F9C5..."), so the stable part of the name is its prefix.
bool FindPropertyByPrefix(std::uintptr_t ustruct, const char* prefix, FieldInfo& out);
