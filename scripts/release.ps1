...
<#
.SYNOPSIS
    Cuts a release of Trepang2 Head Tracking: stamp version, changelog, package,
    commit, tag, push.
...
try {
    ...
    Update-VersionInFile -Path 'CMakeLists.txt' -Pattern 'project\(Trepang2HeadTracking VERSION [0-9.]+' -Replacement "project(Trepang2HeadTracking VERSION $new"
