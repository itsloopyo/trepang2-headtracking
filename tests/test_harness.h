...
#define CHECK(expr) ::t2_test::Record((expr), #expr, __FILE__, __LINE__)
#define CHECK_NEAR(actual, expected, tolerance) \
    ::t2_test::RecordNear((actual), (expected), (tolerance), \
...
#define CHECK_MSG(expr, what) ::t2_test::Record((expr), (what), __FILE__, __LINE__)
#define CHECK_NEAR_MSG(actual, expected, tolerance, what) \
    ::t2_test::RecordNear((actual), (expected), (tolerance), (what), __FILE__, __LINE__)
